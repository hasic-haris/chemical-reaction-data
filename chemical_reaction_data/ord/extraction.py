...
class OrdExtractionUtilities:
    ...
    def extract_2021_kearnes_et_al(
        ...
        """
        Extract the ORD by (2021, Kearnes, S.M., et al.).
        ...
        try:
            if enable_logger:
                getLogger(__name__).info(
                    "Started the extraction of the ORD by (2021, Kearnes, S.M., et al.)."
                )
            ...
            if enable_logger:
                getLogger(__name__).info(
                    "Completed the extraction of the ORD by (2021, Kearnes, S.M., et al.). "
